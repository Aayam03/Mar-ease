...
/**
 * A screen for the user to select the number of players.
 */
@Composable
fun PlayerSelectionScreen(onPlayersSelected: (Int) -> Unit) {
...
@Composable
fun PlayerSelectionPreview() {
    CardTheme {
        PlayerSelectionScreen(onPlayersSelected = {})
    }
}
